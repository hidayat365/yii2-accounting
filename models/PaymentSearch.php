...
/**
 * PaymentSearch represents the model behind the search form about `app\models\Journals`.
 */
class PaymentSearch extends Journals
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'type_id' => JournalTypes::find()->where(['code' => 'BPV'])->one()->id,
