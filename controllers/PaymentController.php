...
/**
 * PaymentController implements the CRUD actions for Journals model.
 */
class PaymentController extends Controller
{
    ...
    public function actionCreate()
    {
      ...
      $model->payment = 0;
      $model->closing = 0;
      $model->type_id = JournalTypes::find()->where(['code' => 'BPV'])->one()->id;;
      ...
      if ($model->load(Yii::$app->request->post())) {
          ...
          if ($model->account_id) {
            ...
            $total_row->credit = $total *$model->currency_rate1;
            $total_row->credit_real = $total;
            $total_row->debet = 0;
            $total_row->debet_real = 0;
    ...
    public function actionUpdate($id)
    {
      ...
      // ambil detail record kecuali summary record
      $details = $model->getJournalDetails()->where('credit_real=0')->all();
      // render view
      return $this->render('update', [
          'model' => $model,
