...
$subtitle = Yii::t('app', ' - Expense Payments');
...
<div class="journals-index">
    ...
    <?= GridView::widget([
        ...
        'toolbar' =>  [
            ['content'=>
                Html::a('<i class="glyphicon glyphicon-plus"></i>&nbsp;&nbsp;'.Yii::t('app', 'Create Payments'), ['create'], ['data-pjax'=>0, 'class' => 'btn btn-success', 'title'=>Yii::t('app', 'Create Payments')])
            ],
            '{export}',
            '{toggleData}'
        ],
